...
class c_TransactionStnkSamsat extends Controller
{
    public function index() {
        return view('dashboard.transaction.stnk-dari-samsat.list');
    }
    ...
    public function validasi($nopo) {
        ...
        return view('dashboard.transaction.stnk-dari-samsat.validasi')->with('data',$data);
    }
