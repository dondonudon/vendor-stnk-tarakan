...
<main>
    <table class="table-trn">
        ...
        <tr>
            ...
            <td>:</td>
            <td>Rp {{ number_format($transaksi->jasa) }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <td>JASA PROSES BBN {{ $transaksi->jumlah }} UNIT</td>
        </tr>
    </table>
    ...
    <table class="table-trn">
        ...
        <tr>
            <td class="text-bold">Banyak Uang</td>
            <td>:</td>
            <td>Rp {{ number_format($transaksi->notice) }}</td>
        </tr>
        <tr>
            <td class="text-bold">Terbilang</td>
            <td>:</td>
            <td>{{ strtoupper(Riskihajar\Terbilang\Facades\Terbilang::make($transaksi->notice,' rupiah')) }}</td>
        </tr>
        <tr>
            <td class="text-bold">Untuk Pembayaran</td>
            <td>:</td>
            <td>NOTICE dan PNBP {{ $transaksi->jumlah }} UNIT</td>
        </tr>
    </table>
</main>
