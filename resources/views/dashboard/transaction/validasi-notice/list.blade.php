...
@section('title','Transaction - Validasi Notice')
            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Daftar PO Belum Selesai Notice</h4>
                    </div>
                    <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            let listTable = $('#listTable').DataTable({
                scrollX: true,
                ajax: {
                    url: '{{ url('transaction/validasi-notice/list') }}'
                },
                columns: [
                    {data: 'no_po'},
                    {
            ...
            btnValidasi.click(function (e) {
                e.preventDefault();
                window.location = '{{ url('transaction/validasi-notice/validasi') }}/'+dataID;
            })
        });
    </script>
@endsection
