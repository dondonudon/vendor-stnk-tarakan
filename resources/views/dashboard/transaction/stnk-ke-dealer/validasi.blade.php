...
@section('title','Transaction - STNK ke Dealer')
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Daftar Validasi Terima STNK ke DEALER</h4>
                        ...
                        <div class="card-footer bg-whitesmoke">
                            <div class="row justify-content-end">
                                <div class="col-sm-12 col-lg-2 mt-2 mb-lg-0">
                                    <button type="button" class="btn btn-block btn-outline-danger" onclick="window.location = '{{ url('transaction/stnk-ke-dealer') }}'">
                ...
                <form id="tambahKendaraan">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="statusKelengkapan">Validasi STNK ke DEALER</label>
...
@section('script')
    <script type="text/javascript">
        ...
        function reloadDaftar(saved) {
            ...
            $.ajax({
                url: '{{ url('transaction/stnk-ke-dealer/daftar-validasi') }}',
                method: 'post',
                data: data,
        ...
        function checkTotalData(nomorPO) {
            $.ajax({
                url: '{{ url('transaction/stnk-ke-dealer/check-total-data') }}',
                method: 'get',
                data: {no_po: nomorPO},
                success: function (response) {
                    if (response !== 'success') {
                        Swal.fire({
                            ...
                            onClose: function () {
                                window.location = '{{ url('transaction/stnk-ke-dealer') }}';
                            }
                        });
                    }
                },
        ...
        $(document).ready(function () {
            ...
            $('#formData').submit(function (e) {
                ...
                if (validasi.rows().count() === 0) {
                    ...
                    console.log(data);
                    $.ajax({
                        url: '{{ url('transaction/stnk-ke-dealer/submit') }}',
                        method: 'post',
                        ...
                        success: function (response) {
                            if (response['status'] === 'success') {
                                Swal.fire({
                                    ...
                                    onClose: function () {
                                        {{--window.open('{{ url('transaction/stnk-ke-dealer/kuitansi/') }}');--}}
                                            window.location = '{{ url('transaction/stnk-ke-dealer') }}';
                                    }
                                });
                            } else {
