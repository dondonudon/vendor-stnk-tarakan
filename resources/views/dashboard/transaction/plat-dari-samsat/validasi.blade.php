...
@section('title','Transaction - PLAT NO dari SAMSAT')
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Daftar Validasi Terima PLAT No dari SAMSAT</h4>
                        ...
                        <div class="card-footer bg-whitesmoke">
                            <div class="row justify-content-end">
                                <div class="col-sm-12 col-lg-2 mt-2 mb-lg-0">
                                    <button type="button" class="btn btn-block btn-outline-danger" onclick="window.location = '{{ url('transaction/plat-dari-samsat') }}'">
...
@section('script')
    <script type="text/javascript">
        ...
        function checkTotalData(nomorPO) {
            $.ajax({
                url: '{{ url('transaction/plat-dari-samsat/check-total-data') }}',
                method: 'get',
                data: {no_po: nomorPO},
                success: function (response) {
                    if (response !== 'success') {
                        Swal.fire({
                            ...
                            onClose: function () {
                                window.location = '{{ url('transaction/plat-dari-samsat') }}';
                            }
                        });
                    }
                },
        ...
        $(document).ready(function () {
            ...
            $('#formData').submit(function (e) {
                ...
                if (validasi.rows().count() === 0) {
                    ...
                    console.log(data);
                    $.ajax({
                        url: '{{ url('transaction/plat-dari-samsat/submit') }}',
                        method: 'post',
