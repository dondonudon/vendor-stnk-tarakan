            ...
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Validasi BPKB dari SAMSAT</h4>
                    </div>
                    <form id="formData">
                        <div class="card-body">
                            <div class="row">
                        ...
                        <div class="card-footer bg-whitesmoke">
                            <div class="row justify-content-end">
                                <div class="col-sm-12 col-lg-2 mt-2 mb-lg-0">
                                    <button type="button" class="btn btn-block btn-outline-danger" onclick="window.location = '{{ url('transaction/bpkb-dari-samsat') }}'">
...
@section('script')
    <script type="text/javascript">
        function reloadDaftar() {
            ...
            $.ajax({
                url: '{{ url('transaction/bpkb-dari-samsat/daftar-validasi') }}',
                method: 'post',
                data: {no_po: noPO},
                success: function (response) {
                    if (response.length === 0) {
                        Swal.fire({
                            ...
                            html: 'Tidak ada data kendaraan yang perlu divalidasi pada nomor PO "'+noPO+'".<br> Anda akan kembali ke halaman awal BPKB dari SAMSAT. <br>Informasi mengenai Nomor PO ini, dapat anda lihat pada halaman "Transaction/Purchase Order".',
                            onClose: function () {
                                window.location = '{{ url('transaction/bpkb-dari-samsat') }}';
                            }
                        });
                    } else {
        ...
        $(document).ready(function () {
            ...
            btnValidasi.click(function (e) {
                ...
                $.ajax({
                    url: '{{ url('transaction/bpkb-dari-samsat/submit') }}',
                    method: 'post',
                    data: {
                        no_po: noPO,
                        data: dataValidasi
