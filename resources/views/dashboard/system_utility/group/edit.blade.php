                        ...
                        <div class="card-footer bg-whitesmoke">
                            <div class="row justify-content-end">
                                <div class="col-sm-12 col-lg-2 mt-2 mb-lg-0">
                                    <button type="button" class="btn btn-block btn-outline-danger" onclick="window.location = '{{ url('system-utility/menu-group') }}'">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            formData.submit(function (e) {
                e.preventDefault();
                $.ajax({
                    url: '{{ url('system-utility/menu-group/submit') }}',
                    method: 'post',
                    data: $(this).serialize(),
                    success: function (response) {
                        if (response === 'success') {
                            Swal.fire({
                                ...
                                timer: 1000,
                                onClose: function () {
                                    window.location = '{{ url('system-utility/menu-group') }}';
                                }
                            });
                        } else {
