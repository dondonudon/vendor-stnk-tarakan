...
@section('title','Laporan - Pengiriman Plat Nomor')
...
@section('script')
    <script type="text/javascript">
        ...
        function reloadReport(tanggal,dealer) {
            $.ajax({
                url: '{{ url('laporan/pengiriman-plat/list') }}',
                method: 'post',
                data: {
        ...
        $(document).ready(function () {
            ...
            dExcel.click(function (e) {
                ...
                download.src = '{{ url('laporan/pengiriman-plat/export/excel') }}/'+data.join('/');
            });
            ...
            dPdf.click(function (e) {
                ...
                window.open('{{ url('laporan/pengiriman-plat/export/pdf') }}/'+data.join('/'));
            });
