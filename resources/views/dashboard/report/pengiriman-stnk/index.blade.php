...
@section('title','Laporan - Pengiriman STNK')
...
@section('script')
    <script type="text/javascript">
        ...
        function reloadReport(tanggal,dealer) {
            $.ajax({
                url: '{{ url('laporan/pengiriman-stnk/list') }}',
                method: 'post',
                data: {
        ...
        $(document).ready(function () {
            ...
            dExcel.click(function (e) {
                ...
                download.src = '{{ url('laporan/pengiriman-stnk/export/excel') }}/'+data.join('/');
            });
            ...
            dPdf.click(function (e) {
                ...
                window.open('{{ url('laporan/pengiriman-stnk/export/pdf') }}/'+data.join('/'));
            });
